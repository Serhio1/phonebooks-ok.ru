			...
			<div id="contact_fields">
				...
				<form action="<?php echo get_includes_dir('uri'); ?>/contact.php" method="post" id="contact_form">
					...
					<fieldset id="contact_fields_left">
						...
						<!-- Name field -->
						<input id="name" type="text" name="name" placeholder="<?php echo esc_attr( __('Ваше имя*', 'haku') ); ?>" />
						
						<!-- Email field -->
						<input id="email" type="text" name="email" placeholder="<?php echo esc_attr( __('Ваша почта*', 'haku') ); ?>" />
						
						<!-- Subject field -->
						<textarea id="subject" name="subject" placeholder="<?php echo esc_attr( __('Ваш телефон*', 'haku') ); ?>"></textarea>
					...
					<fieldset id="contact_fields_right">
						...
						<!-- Message field -->
						<textarea id="message" name="message" placeholder="<?php echo esc_attr( __('Введите ваше сообщение...', 'haku') ); ?>"></textarea>
						
						<!-- Submit field -->
						<input type="submit" id="submit" value="<?php echo retro_filter( esc_attr( __('Отправить!', 'haku') ) ); ?>" data-str-load="<?php echo retro_filter( esc_attr( __('Отправка..', 'haku') ) ); ?>" data-str-done="<?php echo retro_filter( esc_attr( __('Отправлено!', 'haku') ) ); ?>" />
